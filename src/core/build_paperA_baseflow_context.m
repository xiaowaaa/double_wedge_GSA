...
%BUILD_PAPERA_BASEFLOW_CONTEXT Build the shared Paper-A audit and plotting context.
    ...
    BaseflowPhysicsAudit.wall_model = local_get_field(BaseValidation, 'wall_model', ...
        local_get_field(Config, 'wall_model', 'adiabatic'));
    BaseflowPhysicsAudit.wall_temperature_target = local_get_field(BaseValidation, ...
        'wall_temperature_target', local_get_field(Config, 'T_wall', NaN));
    BaseflowPhysicsAudit.wall_temperature_target_nd = local_get_field(BaseValidation, ...
        'wall_temperature_target_nd', local_get_field(Config, 'T_wall_nd', NaN));
    BaseflowPhysicsAudit.wall_temperature_check_applied = local_get_field(BaseValidation, ...
        'wall_temperature_check_applied', false);
