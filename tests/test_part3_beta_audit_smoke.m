...
%TEST_PART3_BETA_AUDIT_SMOKE Run a tiny Part3 assembly and verify saved beta audits.
    ...
    assert(part3.PressureClosureAudit.rho_from_p_density_residual_max < 1.0e-10, ...
        'Pressure closure audit should preserve the rho_from_p density closure.');
    assert(part3.PressureClosureAudit.pressure_scale_density_residual_max < 1.0e-10, ...
        'Pressure closure audit should preserve the pressure-scale density closure.');
